      ...
      <View style={{ marginHorizontal: 12 }}>
        ...
        >
          ...
          >
            ...
            <Text>Неповній робочий день</Text>
          </Pressable>
          <Pressable
            onPress={() => setAttendanceStatus("hospital")}
            style={{
              backgroundColor: "#C4E0E5",
              padding: 10,
              borderRadius: 8,
